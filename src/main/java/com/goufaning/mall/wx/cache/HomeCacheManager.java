package com.goufaning.mall.wx.cache;
...
public class HomeCacheManager {
    ...
    private static Map<String, Map<String, Object>> cacheDataList = new ConcurrentHashMap<>();
